...
export default class BodyViewNTD extends React.Component {
    ...
    return (
      ...
      >
        <View style={styles.viewText}>
          ...
          <Text style={styles.textDescription}>{userSv.objective}</Text>
        </View>
          ...
          <View style={styles.flexText}>
            <View style={styles.viewInput}>
              <FontAwesome5 name="user-alt" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.gender}</Text>
            </View>
            <View style={styles.viewInputRight}>
              <FontAwesome5 name="calendar-times" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.birthday}</Text>
            </View>
          </View>
          ...
          <View style={styles.flexText}>
            <View style={styles.viewInput}>
              <FontAwesome5 name="mobile-alt" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.phonenumber}</Text>
            ...
            <View style={styles.viewInputRight}>
              <FontAwesome5 name="envelope" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.email}</Text>
            </View>
          </View>
          <View style={styles.flexText}>
            <View style={styles.viewInput}>
              <FontAwesome5 name="map-marker-alt" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.address}</Text>
          ...
          <View style={styles.flexText}>
            <View style={styles.viewInput}>
              <FontAwesome5 name="school" size={17}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.name_of_school}</Text>
            </View>
            <View style={styles.viewInputLess}>
              <FontAwesome5 name="book-reader" size={16}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.major}</Text>
            </View>
          </View>
          ...
          <View style={styles.flexText}>
            <View style={styles.viewInput}>
              <FontAwesome5 name="bookmark" size={18}
                color={'#fff'}
              />
              <Text style={styles.inputText}>{userSv.type_of_student}</Text>
        ...
        <View style={styles.viewInput}>
          <Text style={styles.inputText}>{userSv.skills}</Text>
        </View>
        ...
        <View style={styles.viewInput}>
          ...
          <Text style={styles.inputText}>{userSv.experience}</Text>
        ...
        <View style={styles.viewInput}>
          ...
          <Text style={styles.inputText}>{userSv.certification}</Text>
        ...
        <View style={styles.viewInput}>
          ...
          <Text style={styles.inputText}>{userSv.additional_info}</Text>
        ...
        <View style={styles.bottomStyle}>
          <View style={styles.styleViewCv}>
            <TouchableOpacity onPress={() => this.props.handleGoBack()}>
              <FontAwesome5 name="times-circle" color='#fff' fontSize={30} />
            </TouchableOpacity>
          </View>
        </View>
